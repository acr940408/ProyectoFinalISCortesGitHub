<%-- 
    ...
    Created on : 22/05/2024, 04:06:33 AM
            ...
            <div class="jumbotron">
                ...
                <div class="thumbnail">
                    <center>
                        ...
                        <hr>
                        <h2>Registro productos vendedor </h2>                   
                        <h3> Captura Datos </h3>
                        <form method="post">
                            <div class="form-group">
                                <h3> Id Producto </h3>
                                <input type="number" name="Id producto"class="form-control" placeholder="Id producto" required/>
                                <h3> Descripción </h3>
                                ...
                                <br>
                                <input type="submit" class="btn-danger" value="Alta de productos" />
                            </div>
                        </form>
                    </center> 
                </div>
