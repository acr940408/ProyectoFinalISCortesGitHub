<%-- 
    Document   : index
    Created on : 22/05/2024, 02:01:31 AM
...
<html>
    ...
    <body style="background-color: #9966ff">
        <div class="container">
            <div class="jumbotron">
                <center>
                    <h3>PAPELERÍAS RVC</h3>
                    <img src="imagenes/RVC.PNG" class="img img-responsive" alt="logo"/>    
                </center>
                <div class="thumbnail">
                    <center>
                        <h2>Menu general (selecciona Opcion)</h2>
                        <hr>
                        <a href="consultar.jsp"><h3> Consulta Vendedores</h3> </a>

                        <a href="registrar.jsp"><h3> Registra Vendedor</h3> </a>

                        <a href="editar.jsp"><h3> Edita Vendedor</h3> </a>

                        <a href="eliminar.jsp"><h3> Elimina Vendedor </h3> </a>
...
<jsp:include page="librerias/librerias2.jsp"/>
